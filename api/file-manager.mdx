---
title: "FileManager Utility — Chromologger Internals"
...
<ResponseField name="return" type="TextIOWrapper">
  The open file object on success. Any exception raised during `open()` is re-raised to the caller — the method does not swallow errors silently.
</ResponseField>
